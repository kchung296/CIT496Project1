...
public class htmlUnitTest {				
	...
	public static void main(String[] args) {
		...
		Assert.assertNotEquals(pageTitle, "Kevin Chung CIT496");
		...
		if (pageTitle.contains("Kevin")) {
			System.out.println("\nThis page does contain Kevin\n");
			Assert.assertTrue(pageTitle.contains("Kevin"));
		}
		else {
			System.out.println("\n Kevin does not exist.");
			Assert.assertFalse(pageTitle.contains("Kevin"));
		}		     
